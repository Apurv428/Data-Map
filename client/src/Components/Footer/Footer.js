...
const Footer = () => {
  ...
  const api_key = "793f2a03af5ed1e5355999fdee3ca252";
  ...
  const fetchVideo = async () => {
    ...
    const video1 = await axios.get(
      `https://api.themoviedb.org/3/movie/${idArray[0]}/videos?api_key=793f2a03af5ed1e5355999fdee3ca252&language=en`
    );
    setVideo1(video1.data.results[0].key);

    const video2 = await axios.get(
      `https://api.themoviedb.org/3/movie/${idArray[1]}/videos?api_key=793f2a03af5ed1e5355999fdee3ca252&language=en`
    );
    setVideo2(video2.data.results[0].key);

    const video3 = await axios.get(
      `https://api.themoviedb.org/3/movie/${idArray[2]}/videos?api_key=793f2a03af5ed1e5355999fdee3ca252&language=en`
    );
    setVideo3(video3.data.results[0].key);

    const video4 = await axios.get(
      `https://api.themoviedb.org/3/movie/${idArray[3]}/videos?api_key=793f2a03af5ed1e5355999fdee3ca252&language=en`
    );
